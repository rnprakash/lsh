...
% In this case, $d$ gives us a notion of distance that takes this statistic into consideration, a classifier considering $d$ can perform the attack
...
% Discuss how kernel transforms give rise to RKHS?
...
%% This only matters when discussing kernel transforms - which I need to do but not sure how yet
\iffalse{}
